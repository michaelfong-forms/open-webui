...
USER_PERMISSIONS_WORKSPACE_DATASETS_ACCESS = (
    os.environ.get("USER_PERMISSIONS_WORKSPACE_DATASETS_ACCESS", "False").lower() == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    "workspace": {
        ...
        "datasets": USER_PERMISSIONS_WORKSPACE_DATASETS_ACCESS,
    },
    "sharing": {
